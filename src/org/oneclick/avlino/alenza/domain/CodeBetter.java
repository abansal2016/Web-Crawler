...
public class CodeBetter extends BaseDomain {
  ...
  public boolean getNextButton(WebDriver driver) {
    while (true) {
      try {
        List<WebElement> nextList = driver.findElements(By.cssSelector("div[class='nav-next']"));
        //System.out.println("URL= " + url);
        //System.out.println("Nextlist size=" + nextList.size());
        if (nextList.size() == 0)
          return false;

        nextList.get(0).findElement(By.tagName("a")).click();
